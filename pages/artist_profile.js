...
const artist_profile = ({ products }) => {
  ...
  return (
    <div className="mt-32">
      ...
      <div className="flex mb-32 text-white gap-9 ">
        ...
        <div>
          ...
          <div className="flex gap-[600px]">
            <button className="px-12 py-2 text-black bg-green-200 border rounded">
              Follow
            </button>
      ...
      <div>
        <h1 className="mb-2 text-3xl font-bold text-center text-gray-200 ">BIO</h1>
        <h3 className="mb-24 font-semibold text-center text-gray-200"> when an artist fills out the for and gives bio put it here</h3>
      </div>
</div>
      <div>
